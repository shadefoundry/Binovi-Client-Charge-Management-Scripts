...
def prepareLists():
    ...
    for i in range(len(df2.index)):
        ...
        x = order(df2.iloc[i, 0], df2.iloc[i, 5], df2.iloc[i, 11], df2.iloc[i, 20], df2.iloc[i, 16], df2.iloc[i, 2])
        oliAll.append(x)
...
def verifyMonthlyPaymentConsistency():
...
#this function handles monthly payment consistency
verifyMonthlyPaymentConsistency()
